          ...
          <div class="flex flex-wrap">
            <div class="xl:w-1/3 md:w-1/2 sm:w-full p-4">
              <div class="border border-gray-300 p-6 rounded-lg h-48">
                <WorkCard
                  WorkCardtitle="CV Builder"
                  WorkCarddescription="This project is made up of React, Redux and Material-UI"
                />
                <a
                  href="https://kaw-cv-builder.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
            ...
            <div class="xl:w-1/3 md:w-1/2 sm:w-full p-4">
              <div class="border border-gray-300 p-6 rounded-lg h-48">
                <WorkCard
                  ...
                  WorkCarddescription="This project is made up of React, Redux and Bootstrap"
                />
                <a
            ...
            <div class="xl:w-1/3 md:w-1/2 sm:w-full p-4">
              <div class="border border-gray-300 p-6 rounded-lg h-48">
                <WorkCard
                  ...
                  WorkCarddescription="This project is made up of React, Tailwind and the Countries API"
                />
                <a
            ...
            <div class="xl:w-1/3 md:w-1/2 sm:w-full p-4">
              <div class="border border-gray-300 p-6 rounded-lg h-48">
                <WorkCard
                  ...
                  WorkCarddescription="This is a Frontend Mentor project. It is made up of React, Bulma and the Advice Slip API"
                />
                <a
