        ...
        <div class="rounded-lg shadow-xl bg-gray-900 text-white">
          ...
          <div class="px-8 py-6">
            <p>
              ...
              <span class="text-yellow-100">aboutMe</span> ={" "}
            ...
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;name:{" "}
              <span class="text-green-300">'Kerry Warnes'</span>,
            </p>
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;Age:{" "}
              <span class="text-green-300">'31'</span>,
            </p>
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;Sex:{" "}
              <span class="text-green-300">'Female'</span>,
            </p>
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;Goal:{" "}
